...
# Working directory:
mainFolder = 'C:\\Users\\psachdeva\\Documents\\01_Promotion\\01_ANA_2.1\\FE\\Results'
...
initDirFE = 'C:\\Users\\psachdeva\\Documents\\01_Promotion\\01_ANA_2.1\\FE\\Results'
wd_fe = folderDataset(initDirFE, 'Dataset of the finite element computations')

# Data of semi-analytical method:
initDirSA = 'C:\\Users\\psachdeva\\Documents\\01_Promotion\\01_ANA_2.1\\Lek63\\plate\\bending\\cross ply'
...
def importStressInnerAnalytical():
    stressComponent = ['Sigxx', 'Sigyy', 'Sigzz', 'Tauxy', 'Tauxz', 'Tauyz']
    sumStresses = []
    ...
    for ii in range(N):
        ...
        for jj in range(len(circPos)):
            for kk in range(len(axialPos)):
                ...
                if len(radii) == 0:
                    radii.append(list(dataset[noMeanValueRunVar][6]))
                else:
                    pass
                noMeanValueRunVar += 1
...
plotInner(importStressInnerFiniteElement(),importStressInnerAnalytical())
