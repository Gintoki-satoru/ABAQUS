...
def create_layer_part(model, layer_index):
    ...
    inner_case1 = [superellipsoid_point_3d(0.0, th, a_i, b_i, c_i, n1, n2) for th in theta_sp]
    outer_case1 = [superellipsoid_point_3d(0.0, th, a_o, b_o, c_o, n1, n2) for th in theta_sp]
    # --- Case 2 (theta=0) ---
